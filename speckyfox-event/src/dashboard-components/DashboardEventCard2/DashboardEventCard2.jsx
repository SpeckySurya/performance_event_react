...
import "./DashboardEventCard2.css";
...
export default function DashboardEventCard2({ event, initialSetup }) {
        ...
        <Stack p={"20px"} spacing={1}>
          ...
          >
            ...
            <Stack spacing={1} width={"40%"}>
              ...
              <Stack spacing={1} alignItems={"end"} py={1}>
